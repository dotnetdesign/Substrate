...
namespace DotNetDesign.EntityFramework
{
    ...
    public interface IEntity<out TEntity, TEntityData, TEntityRepository> : IEntity<TEntity, Guid, TEntityData, TEntityRepository>
    ...
    /// <typeparam name="TEntityData">The type of the entity data.</typeparam>
    /// <typeparam name="TEntityRepository">The type of the entity repository.</typeparam>
    public interface IEntity<out TEntity, TId, TEntityData, TEntityRepository> : IVersionable<TEntity>, IObservableEntity<TId>
        ...
        where TEntityRepository : class, IEntityRepository<TEntityRepository, TEntity, TId, TEntityData>
    {
        ...
        ///   <c>true</c> if the specified property has changed; otherwise, <c>false</c>.
        /// </returns>
        bool HasPropertyChanged<TProperty>(Expression<Func<TEntityData, TProperty>> property, out TProperty originalValue);
